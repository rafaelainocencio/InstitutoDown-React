        ...
        < >
            <main >
                ...
                <div className="text-center">
                    <h1 className='nome_home'>Empresas <span className="nome_home2">Parceiras</span> </h1>
                </div>
                <br />
                <h6 className="m5 titulo_home">Por que o trabalho importa:</h6>
                <p className="m5 titulo_home">
                ...
                <h6 className="m5 titulo_home">Objetivo</h6>
                <p className="m5 titulo_home">
